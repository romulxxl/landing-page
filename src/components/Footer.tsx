            ...
            <div className="flex gap-3">
              {socials.map(({ label, Icon }) => (
                <a
                  ...
                  href="#"
                  aria-label={label}
                  className="w-9 h-9 bg-gray-800 hover:bg-indigo-500 rounded-lg flex items-center justify-center transition-colors duration-200 text-gray-400 hover:text-white"
                >
                  <Icon />
                </a>
              ))}
